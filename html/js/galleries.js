    ...
    window.galleries = {
        ...
        contact_form_popup: {
            ...
            init: function() {
                ...
                $('a[href$="/contactMaster/form/"], .website_contact_form')
                    .unbind()
                    ...
                    .click(function() {
                        ...
                        var item_id = typeof $(this).attr('data-contactMaster-form-item-id') != 'undefined' ? $(this).attr('data-contactMaster-form-item-id') : '';
                        var item_table = typeof $(this).attr('data-contactMaster-form-item-table') != 'undefined' ? $(this).attr('data-contactMaster-form-item-table') : '';
                        var gallery_id = typeof $(this).attr('data-contactMaster-form-gallery-id') != 'undefined' ? $(this).attr('data-contactMaster-form-gallery-id') : '';
                        var gallery_email_address = typeof $(this).attr('data-contactMaster-form-to') != 'undefined' ? $(this).attr('data-contactMaster-form-to') : '';
                        var gallery_email_address_bcc = typeof $(this).attr('data-contactMaster-form-to-bcc') != 'undefined' ? $(this).attr('data-contactMaster-form-to-bcc') : '';
                        var form_heading = typeof $(this).attr('data-contactMaster-form-heading') != 'undefined' ? $(this).attr('data-contactMaster-form-heading') : '';
                        var hide_additional_field_content = $(this).attr('data-contactMaster-form-hide-context') && typeof $(this).attr('data-contactMaster-form-hide-context') != 'undefined' ? ($(this).attr('data-contactMaster-form-hide-context') == '1' ? true : false) : false;
                        var additional_field_content = $(this).attr('data-contactMaster-form-details');
                        var additional_field_image = $(this).attr('data-contactMaster-form-image');
                        var additional_field_parent_id = $(this).attr('data-contactMaster-form-parent-id');
                        var additional_field_type = $(this).attr('data-contactMaster-form-type');
                        ...
                        $.fancybox.open(
                            url_prefix + '/contactMaster/form/' + form_url_params,
                            {
                                type: 'ajax',
                                autoSize: false,
                                height: 'auto',
                                ...
                                afterShow: function() {
                                    ...
                                    $('.fancybox-skin a[title="Close"], .fancybox-skin a[title="Previous"], .fancybox-skin a[title="Next"]').attr("role", "button");
                                    h.accessibility.role_button();
                                    // If the contactMaster/enquiry form contains work/product info, set focus to the form header instead of first input field
            ...
            inline: function() {
                ...
                $('#contact_form_inline, .section-contactMaster.page-form').each(function() {
                    $.ajax({
                ...
                if (instance) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $(instance).removeClass('submitting');
                            if (data['success'] == 1) {
                                $.fancybox((url_prefix + '/contactMaster/form/?modal=1&complete=1'), window.galleries.fancybox.ajax_defaults());
            ...
            init: function() {
                ...
                $('a#mailinglist_signup_popup_link')
                    .click(function() {
                        ...
                        $.fancybox.open(
                            '/contactMaster/mailinglist_signup/?modal=1',
                            {
                                type: 'ajax',
                                autoSize: false,
                                height: 'auto',
