            ...
            axe_automatic_audit: function() {
                ...
                $(".run-axe-audit-button").unbind().click(function(){
                    ...
                    axe.run({exclude: [['#cms-frontend-toolbar']]}, function (err, results) {
                        ...
                        if (err) {
                            $(".axe-dynamic-panel-container").append("<div class='axe-error-message'>Oops! Something went wrong! If you continue experiencing this issue please contactMaster support at suuport@artlogic.net</div>");
                            throw err;
                        }
